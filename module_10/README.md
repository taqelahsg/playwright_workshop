...
**Prerequisites:** Completed Modules 2-9
...
In this capstone project, you will build a comprehensive Playwright test automation suite for the **Taqelah Boutique Demo Site**. This project integrates all concepts from Modules 2-9.
...
Create a GitHub Actions workflow to run tests on push. (Reference: Module 9)
...
- Module 9: [workflows/github/](../module_9/workflows/github/)
